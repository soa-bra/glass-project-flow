...
### المخرجات المطلوبة
- [ ] `PlanningPanel.tsx` - الحاوي الرئيسي
- [ ] `TopToolbar` - الشريط العلوي مع جميع الأدوات
- [ ] `Toolbox` - صندوق الأدوات الأيسر 
- [ ] `CanvasSurface` - سطح الكانفاس الأساسي
- [ ] `Inspector` - لوحة الخصائص اليمنى
- [ ] `useCanvasStore` - إدارة حالة الكانفاس
- [ ] `canvas.ts` - أنواع البيانات الأساسية
...
### المخرجات المطلوبة
- [ ] ThinkingBoard - لوحة تجميع الأفكار
- [ ] KanbanBoard - لوحة كانبان بثلاث أعمدة
- [ ] Voting - نظام التصويت
...
**حالة التنفيذ**: `جاري العمل على المرحلة الأولى`  
