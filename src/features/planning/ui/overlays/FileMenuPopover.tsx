...
export const FileMenuPopover: React.FC<FileMenuPopoverProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div className="absolute top-full right-0 mt-2 w-64 bg-white rounded-[18px] shadow-[0_8px_24px_rgba(0,0,0,0.12)] border border-sb-border py-2 z-toolbar max-h-[calc(100vh-200px)] overflow-y-auto">
        {/* New */}
        <button
