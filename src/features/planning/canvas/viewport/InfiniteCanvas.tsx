...
// ✅ المسارات الجديدة للهيكلة
import CanvasElement from '@/components/Planning/CanvasElement';
import DrawingPreview from '@/components/Planning/DrawingPreview';
import SelectionBox, { useSelectionBox } from '@/features/planning/canvas/selection/SelectionBox';
import StrokesLayer from '@/components/Planning/StrokesLayer';
import PenInputLayer from '@/features/planning/canvas/gestures/PenInputLayer';
import FrameInputLayer from '@/components/Planning/FrameInputLayer';
...
import { CanvasGridLayer } from '@/components/Planning/CanvasGridLayer';
import { RealtimeSyncManager } from '@/components/Planning/collaboration';
import { useCollaborationUser } from '@/hooks/useCollaborationUser';
import MindMapConnectionLine from '@/components/Planning/MindMapConnectionLine';
