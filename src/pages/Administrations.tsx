...
const Administrations = () => {
  return (
    <div dir="rtl" className="relative min-h-screen w-full bg-soabra-solid-bg font-arabic overflow-x-hidden overflow-y-auto pt-[var(--header-height)]">
      <div className="container mx-auto px-0 py-12">
        ...
        <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
          {ADMIN_SECTIONS.map((section) => (
            <GenericCard
              key={section.key}
              className="rounded-3xl shadow-xl hover-scale transition-all text-right font-arabic select-none"
              variant="glass"
              padding="lg"
            >
