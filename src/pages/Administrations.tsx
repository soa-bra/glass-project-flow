...
const Administrations = () => {
    ...
    fontFamily: '"IBM Plex Sans Arabic", Arial, Tahoma, sans-serif'
  }} className="relative min-h-screen w-full bg-dfecf2 font-arabic overflow-x-hidden overflow-y-auto pt-[var(--header-height)]">
      <AdministrationDrawer open={drawerOpen} onOpenChange={open => {
      setDrawerOpen(open);
      ...
      <div className="container mx-auto px-0 py-12">
        ...
        <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
          {ADMIN_SECTIONS.map(section => <GenericCard key={section.key} className="rounded-3xl shadow-xl hover-scale transition-all text-right font-arabic select-none cursor-pointer" variant="glass" padding="lg" onClick={() => {
