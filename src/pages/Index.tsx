    ...
    <div dir="rtl" className="relative min-h-screen w-full bg-soabra-solid-bg font-arabic overflow-hidden mx-0 px-0">
      ...
      <div className="flex h-screen pt-[var(--header-height)] overflow-hidden py-0 mx-0 my-0 px-0">
        ...
        <div className={`fixed h-[calc(100vh-var(--sidebar-top-offset))] transition-all duration-500 ease-in-out ${isSidebarCollapsed ? 'content-layout-collapsed' : 'content-layout-expanded'}`} style={{
          ...
          <div 
            className="rounded-t-3xl transition-all duration-300 hover:shadow-xl hover:scale-[1.02] transform w-full h-full flex flex-col overflow-hidden px-0 mx-[25px]"
            style={{
              background: 'linear-gradient(135deg, #B8E6B8 0%, #87CEEB 50%, #4DA6A6 100%)'
            }}
          >
        ...
        {selectedProjectId && (
          <div className="fixed bg-white/40 backdrop-blur-sm rounded-3xl shadow-lg transition-all duration-500 ease-in-out transform" style={{
            width: '60vw',
