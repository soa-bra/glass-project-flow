...
export const LegalTab: React.FC<LegalTabProps> = ({ data, loading }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* عداد العقود */}
      <Card className="bg-white/40 backdrop-blur-sm hover:bg-white/50 transition-all hover:scale-[1.02] hover:shadow-md">
        ...
        <div className="grid gap-3">
          {data.upcoming.map(contract => {
            ...
            return (
              <Card 
                key={contract.id} 
                className="bg-white/40 backdrop-blur-sm hover:bg-white/50 transition-all hover:scale-[1.02] hover:shadow-md"
              >
      ...
      <div className="flex justify-center mt-6">
        <button 
          className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 flex items-center gap-2"
        >
