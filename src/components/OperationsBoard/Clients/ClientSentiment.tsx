  ...
  return (
    <AppCardSurface density="standard">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-bold text-right font-arabic">تحليل مشاعر العملاء</h3>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {sentimentData.map(client => (
          <div key={client.clientId} className="bg-gray-50 border border-[#DADCE0] rounded-2xl p-4 hover:bg-gray-100 transition-colors">
            ...
            <div className="space-y-2">
              <div className="bg-gray-200 h-2 rounded-full">
                <div
                  className={`h-2 rounded-full transition-all duration-300 ${client.score >= 80 ? 'bg-green-500' : client.score >= 60 ? 'bg-yellow-500' : 'bg-red-500'}`}
