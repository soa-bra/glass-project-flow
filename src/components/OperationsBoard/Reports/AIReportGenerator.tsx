          ...
          suggestions.map(suggestion => (
            <div key={suggestion.id} className="bg-gray-50 border border-[#DADCE0] rounded-2xl p-4 hover:bg-gray-100 transition-colors">
              <div className="flex items-start justify-between mb-3">
                ...
                <Badge className={getConfidenceColor(suggestion.confidence)}>{suggestion.confidence}% دقة</Badge>
              </div>
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Button size="sm" variant="outline" className="rounded-full">معاينة</Button>
