    ...
    <div className="rounded-[24px] bg-white border border-[#DADCE0] p-6">
      ...
      <div className="flex gap-2 mb-4">
        <div className="flex-1">
          <Input placeholder="ابحث في التقارير..." className="text-right rounded-[24px] bg-white border-[#DADCE0]" />
        </div>
      ...
      <div className="space-y-4 max-h-[400px] overflow-y-auto">
        {templates.map(template => (
          <div key={template.id} className="bg-gray-50 border border-[#DADCE0] rounded-[24px] p-4 hover:bg-gray-100 transition-colors">
            ...
            <div className="flex flex-wrap gap-1 mb-3">
              ...
              {template.tags.length > 3 && (
                <BaseBadge variant="outline" className="text-xs">+{template.tags.length - 3}</BaseBadge>
              )}
            </div>
