    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        {data.projects.sort((a, b) => (b.spent/b.budget) - (a.spent/a.budget)).map(project => {
          ...
          return (
            <Card key={project.id} className="bg-white/40 backdrop-blur-sm hover:bg-white/50 transition-all hover:scale-[1.02] hover:shadow-md">
      ...
      <div className="flex justify-center mt-6">
        <button 
          className="bg-amber-500 hover:bg-amber-600 text-white py-2 px-6 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 flex items-center gap-2"
        >
