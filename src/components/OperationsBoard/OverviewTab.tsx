...
export const OverviewTab: React.FC<OverviewTabProps> = ({
  ...
  // بيانات تجريبية للخط الزمني
  const timelineData = [
    {
      id: 1,
      title: 'الاجتماع التوضيحي مع القيادة العليا',
      department: 'داخلي',
      date: '2024-05-12',
    ...
    {
      id: 2,
      title: 'متابعة المشروع مع شركة النجمة',
  ...
  return (
    <div className="h-full overflow-auto space-y-6 py-0 px-6">
      {/* الصف الأول - المؤشرات الإحصائية */}
      <ProjectStatsSection stats={mockData.stats} />
      
      {/* الصف الثاني - الخط الزمني للأحداث القادمة */}
      <TimelineWidget timeline={timelineData} className="mb-6" />
      ...
      <div className="grid grid-cols-3 gap-6">
        <FinancialOverviewChart title="النظرة المالية" data={mockData.financial} />
