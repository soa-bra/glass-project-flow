...
export const OperationsBoard = ({
  ...
  const fetchTabData = async (tabName: string) => {
    ...
    const mockData = {
      ...
      hr: {
        ...
        distribution: [{
          project: 'المشروع الأول',
          members: 12
        }, {
          project: 'المشروع الثاني',
          members: 8
        }, {
          project: 'المشروع الثالث',
          members: 9
        }, {
          project: 'المشروع الرابع',
          members: 7
        }, {
          project: 'المشروع الخامس',
          members: 6
        }]
      },
      clients: {
        active: [{
          ...
          id: 4,
          name: 'هيئة تطوير المدن',
          projects: 1
        }],
        nps: [{
          id: 1,
          score: 92,
          client: 'وزارة التخطيط'
        }, {
          id: 2,
          score: 87,
          client: 'مؤسسة التنمية الحضرية'
        }, {
          id: 3,
          score: 79,
      ...
      reports: {
        templates: [{
          id: 1,
          name: 'تقرير أداء المشاريع الشهري'
        }, {
          id: 2,
  ...
  return <div className={`fixed transition-all duration-500 ease-in-out ${isVisible ? 'translate-x-0' : 'translate-x-[100%]'}`} style={{
    width: '60vw',
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} dir="rtl" className="w-full h-full my-0 mx-0 px-0">
          <div className="border-b border-gray-200/30 h-[120px] flex items-center px-[30px]">
            <div className="w-full flex items-center gap-2 overflow-x-auto">
              {tabItems.map(item => {
              return <button key={item.value} onClick={() => setActiveTab(item.value)} className="flex items-center justify-center px-2.5 py-2.5 transition-all duration-400 ease-in-out group relative min-w-fit">
