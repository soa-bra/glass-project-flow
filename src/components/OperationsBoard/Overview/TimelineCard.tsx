  ...
  return (
    <>
      <BaseCard 
        variant="glass" 
        size="sm" 
        className="col-span-3 h-[250px] overflow-hidden" 
      ...
      >
        ...
        >
          ...
          <div className="relative min-w-[2400px] h-[220px]">
            {/* خط التايم لاين */}
      ...
      <Dialog open={showAddEventModal} onOpenChange={setShowAddEventModal}>
        <DialogContent 
          className="max-w-3xl max-h-[90vh] rounded-[24px] p-0 border-0 bg-transparent shadow-none overflow-hidden"
          style={{
        ...
        >
          <DialogHeader className="flex items-center justify-between p-6 border-b border-black/10">
            ...
            <button 
              ...
              className="w-8 h-8 rounded-full bg-transparent hover:bg-black/5 flex items-center justify-center text-black transition-colors"
            >
              <X size={16} />
            </button>
          </DialogHeader>
            ...
            <div className="space-y-2">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <button
                    className={cn(
                      "w-full px-4 py-3 rounded-3xl bg-white/30 border border-black/20 focus:border-black text-black placeholder-black/50 text-right font-arabic transition-colors",
                      !newEventDate && "text-black/50"
                    )}
                  >
          ...
          <div className="flex items-center justify-end gap-3 p-6 border-t border-black/10">
            ...
            <button
              ...
              className="px-6 py-3 bg-black hover:bg-black/90 rounded-full text-white font-medium font-arabic transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              إضافة الحدث
            </button>
          </div>
