      ...
      backgroundColor: '#f2ffff'
        ...
        msOverflowStyle: 'none'
          ...
          <div className="relative min-w-[2400px] h-[150px] px-0 mx-[0px] py-0 my-[5px]">
            ...
            <div style={{
            top: '60px'
          }} className="flex items-start h-20 justify-between w-full absolute top-2 left-0 px-0 mx-0 py-0 my-[3px]">
              {eventsList.map((event, idx) => <div key={idx} className="flex flex-row text-right relative mx-[115px]">
                  {/* البيانات النصية */}
