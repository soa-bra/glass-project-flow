  ...
  return <>
      ...
      backgroundColor: '#f2ffff'
        ...
        msOverflowStyle: 'none'
          ...
          <div className="relative min-w-[2400px] h-[150px] py-0 px-0 mx-[0px] my-[8px]">
            {/* خط التايم لاين */}
            <div className="absolute top-[115px] left-0 w-[200%] h-[1px] bg-black py-0 my-0"></div>

            <div style={{
            top: '60px'
          }} className="flex items-start justify-between w-full absolute top-5 left-0 px-0 mx-0 my-px">
              {eventsList.map((event, idx) => <div key={idx} className="flex flex-row h-15 text-right relative px-0 mx-[115px] py-0 my-px">
                  {/* البيانات النصية */}
                  <div className="flex flex-col bottom-8 items-end space-y-[5px] mr-[0px] py-0 my-0 mx-0 px-0">
                    <div className="flex items-baseline space-x-1 font-arabic">
                      <div className="text-[24px] text-black font-bold mx-[13px]">{event.day}</div>
                  ...
                  <div style={{
                top: '55px'
              }} className="flex flex-col top-9 items-center relative my-0 py-0 mx-px">
