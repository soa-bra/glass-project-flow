  ...
  return <>
      ...
      backgroundColor: '#f2ffff'
        ...
        msOverflowStyle: 'none'
          ...
          <div className="relative min-w-[2400px] h-[140px] px-0 mx-[0px] py-0 my-[25px]">
            {/* خط التايم لاين */}
            <div className="absolute top-[120px] left-0 w-[200%] h-[1px] bg-black py-0 my-0"></div>

            <div style={{
            top: '60px'
          }} className="flex items-start h-20 justify-between w-full absolute top-2 left-0 mx-0 py-0 my-[05px] px-[8px]">
              {eventsList.map((event, idx) => <div key={idx} className="flex flex-row text-right relative px-0 mx-[240px]">
                  {/* البيانات النصية */}
                  <div className="flex flex-col bottom-2 items-end space-y-[1px] px-0 mx-[2px]">
                  ...
                  <div style={{
                top: '55px'
              }} className="flex flex-col top-9 items-center relative py-0 mx-px px-0 my-[10px]">
