...
export const StatisticsCard: React.FC<StatisticsCardProps> = ({
  ...
  return <BaseCard variant="glass" size="md" className="h-[180px]" style={{
    backgroundColor: '#f3ffff'
      ...
      <div className="flex gap-14 h-ful w-full overflow-hidden my-0 py-[20px]">
        ...
        {/* الرسم البياني - 4/5 من المساحة */}
        <div className="w-4/5 flex h-20 justify-center items-center overflow-hidden">
