...
export const TimelineEventItem: React.FC<TimelineEventItemProps> = ({
  ...
  return <div className="relative flex flex-col items-center min-w-fit group px-6 my-0 py-0">
      {/* التاريخ في الأعلى */}
      ...
      <button onClick={() => onEventClick(event)} onPointerDown={e => e.stopPropagation()} className="w-6 h-6 rounded-full bg-gray-800 border-2 border-white shadow-md hover:shadow-lg transition-all duration-200 hover:scale-110 active:scale-95 relative z-20 focus:outline-none focus:ring-2 focus:ring-gray-400 py-0 my-[15px]" />
