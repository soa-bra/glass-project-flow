    ...
    <div className="grid grid-cols-3 gap-6 mb-6">
      ...
      <div className="text-right p-6">
        ...
        <div className="flex flex-col items-end mb-1">
          <div className="text-5xl font-normal text-gray-900 font-arabic mb-1">
            {stats.expectedRevenue}
          </div>
          <div className="text-[10px] text-gray-400 font-arabic font-bold">K SAR</div>
        </div>
      ...
      <div className="text-right p-6">
        ...
        <div className="flex flex-col items-end mb-1">
          ...
          <div className="text-[10px] text-gray-400 font-arabic font-bold">شكاوى</div>
        </div>
      ...
      <div className="text-right p-6">
        ...
        <div className="flex flex-col items-end mb-1">
          ...
          <div className="text-[10px] text-gray-400 font-arabic font-bold">مشاريع</div>
        </div>
