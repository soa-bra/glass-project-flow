...
export const HRWidget: React.FC<HRWidgetProps> = ({
  ...
  return <BaseCard size="md" variant="glass" neonRing={hasVacancies ? 'warning' : 'success'} header={<h3 className="text-sm font-arabic font-bold text-gray-800">
          الموارد البشرية
        </h3>} className="h-[180px]">
      <div className="flex-1 flex flex-col justify-center">
        <div className="flex justify-center items-center mb-4 px-[25px]">
        ...
        <Progress value={fillPercentage} className="h-1 bg-blue-200" indicatorClassName="bg-blue-500" />
      </div>
    </BaseCard>;
};