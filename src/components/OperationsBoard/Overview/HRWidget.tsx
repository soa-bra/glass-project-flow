...
export const HRWidget: React.FC<HRWidgetProps> = ({
  ...
  return (
    <GenericCard className="h-full">
      <h3 className="text-lg font-arabic font-bold mb-4 text-right text-gray-800">الموارد البشرية</h3>
      
      <div className="flex justify-center items-center mb-4">
        <div className="text-center ml-4">
          <div className="text-2xl font-bold text-blue-500 mb-1">{hr.members}</div>
          <div className="text-xs text-gray-600">أعضاء الفريق</div>
        </div>
        <div className="text-center ml-4">
          <div className="text-2xl font-bold text-orange-500 mb-1">{hr.onLeave}</div>
          <div className="text-xs text-gray-600">في إجازة</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-purple-500 mb-1">{hr.vacancies}</div>
