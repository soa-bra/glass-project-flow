...
// SoaBra brand colors from design tokens (Row 2)
const SoaBra_COLORS = [
  {
    color: "#3DBE8B",
    label: "أخضر",
            ...
            <ColorPicker.Positioner>
              <ColorPicker.Content className="bg-background border border-border rounded-lg p-4 shadow-lg space-y-4 z-50 w-80">
                ...
                <div className="flex gap-3">
                  <ColorPicker.ChannelInput
                    channel="hex"
                    className="w-20 flex-1 text-base text-center border border-border rounded-full bg-transparent text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent px-0 py-0"
                  />
                  <ColorPicker.ChannelInput
                    channel="alpha"
                    className="w-10 text-base text-center border border-border rounded-full bg-transparent text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent py-0 px-0"
                  />
                </div>
