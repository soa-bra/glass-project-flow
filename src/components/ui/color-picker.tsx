        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            <ColorPicker.Control className="flex-1">
              <ColorPicker.ChannelInput channel="hex" className="w-full px-3 py-2 text-sm border border-border rounded-md bg-[hsl(var(--panel))] text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent" />
            </ColorPicker.Control>
            ...
            <ColorPicker.Positioner>
              <ColorPicker.Content className="bg-background border border-border rounded-lg p-4 shadow-lg space-y-4 z-50 w-80">
                ...
                <div className="flex gap-3">
                  <ColorPicker.ChannelInput channel="hex" className="flex-1 text-base text-center border border-border rounded-full bg-transparent text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent py-px px-[21px]" />
                  <ColorPicker.ChannelInput channel="alpha" className="w-24 text-base text-center border border-border rounded-full bg-transparent text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent py-0 px-0" />
                </div>
