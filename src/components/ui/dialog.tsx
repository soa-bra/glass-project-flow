...
const DialogHeader = ({
  ...
  <div
    className={cn("flex items-center justify-between mb-3 min-h-[56px]", className)}
    {...props}
  />
);
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-[20px] font-bold text-[#0B0F12] font-arabic", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-sm text-[rgba(11,15,18,0.65)] font-arabic", className)}
    {...props}
  />
));
