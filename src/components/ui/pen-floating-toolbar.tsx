...
const BrushSizeDropdown = ({
  ...
  return (
    ...
    >
      <button
        className="h-8 px-2 flex items-center gap-1 rounded-md hover:bg-[hsl(var(--ink)/0.1)] transition-colors text-xs font-medium min-w-[50px] justify-between"
        onMouseDown={(e) => {
          e.preventDefault();
          e.stopPropagation();
        }}
        ...
        {isOpen && (
          ...
          >
            {BRUSH_SIZES.map((size) => (
              <button
                key={size}
                className={`w-full flex items-center gap-2 px-3 py-1.5 text-sm hover:bg-[hsl(var(--ink)/0.05)] ${
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
              ...
              {QUICK_COLORS.map((color) => (
                <button
                  ...
                  className={`w-6 h-6 rounded border-2 transition-transform hover:scale-110 ${
                    value === color ? 'border-[hsl(var(--ink))]' : 'border-transparent'
                  }`}
            ...
            <button
              className="w-full text-center text-xs text-[hsl(var(--ink-60))] hover:text-[hsl(var(--ink))] py-1"
              onMouseDown={(e) => {
                e.preventDefault();
                e.stopPropagation();
              }}
      ...
      {isVisible && (
        ...
        >
          ...
          <ToolbarButton
            label="خط صلب"
            icon={Minus}
            isActive={penSettings.style === 'solid'}
          ...
          <ToolbarButton
            label="خط متقطع"
            icon={MoreHorizontal}
            isActive={penSettings.style === 'dashed'}
          ...
          <ToolbarButton
            label="خط نقطي"
            isActive={penSettings.style === 'dotted'}
          ...
          <ToolbarButton
            label="خط مزدوج"
            isActive={penSettings.style === 'double'}
