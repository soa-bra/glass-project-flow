  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={cn(
          'sb-modal-shell',
          '[&_input]:min-h-[50px] [&_input]:rounded-[24px] [&_input]:border-black/20 [&_input]:bg-white/30 [&_input]:px-4 [&_input]:py-2.5 [&_input]:text-right [&_input]:text-base [&_input]:font-normal [&_input]:text-black [&_input]:placeholder:font-normal [&_input]:placeholder:text-[#8A8A8A] [&_input]:focus:border-black [&_input]:focus:ring-0',
          ...
          '[&_[data-slot=select-trigger]]:min-h-[50px] [&_[data-slot=select-trigger]]:rounded-[24px] [&_[data-slot=select-trigger]]:border-black/20 [&_[data-slot=select-trigger]]:bg-white/30 [&_[data-slot=select-trigger]]:px-4 [&_[data-slot=select-trigger]]:py-2.5',
          '[&_[role=combobox]]:min-h-[50px] [&_[role=combobox]]:rounded-[24px] [&_[role=combobox]]:border-black/20 [&_[role=combobox]]:bg-white/30 [&_[role=combobox]]:px-4 [&_[role=combobox]]:py-2.5 [&_[role=combobox]]:text-right [&_[role=combobox]]:text-base [&_[role=combobox]]:font-normal [&_[role=combobox]]:text-black [&_[role=combobox]]:focus:border-black [&_[role=combobox]]:focus:ring-0',
          '[&_button[data-field-trigger=true]]:min-h-[50px] [&_button[data-field-trigger=true]]:rounded-[24px] [&_button[data-field-trigger=true]]:border-black/20 [&_button[data-field-trigger=true]]:bg-white/30 [&_button[data-field-trigger=true]]:px-4 [&_button[data-field-trigger=true]]:py-2.5',
          widthCls,
