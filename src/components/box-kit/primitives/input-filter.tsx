...
const dateTriggerClass = 'flex min-h-[56px] w-full items-center justify-between rounded-[24px] border border-black/20 bg-white px-4 py-3 text-right text-base font-normal text-black font-arabic transition-colors outline-none ring-0 focus:border-black focus:outline-none focus:ring-0';
