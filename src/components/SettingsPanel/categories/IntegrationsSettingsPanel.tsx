              ...
              return <div key={integration.id} style={{
                ...
                <div className="flex gap-2 mt-4">
                  {integration.status === 'connected' ? <>
                      <button onClick={() => disconnectIntegration(integration.id)} className="flex-1 px-3 py-2 bg-red-500 text-white rounded-full text-xs font-medium bg-[f1b5b9]">
                        قطع الاتصال
                      </button>
                      ...
                      <button onClick={() => startAISetupAssistant(integration.id)} className="flex-1 px-3 py-2 text-white rounded-full text-xs font-medium bg-[a4e2f6]">إعداد ذكي</button>
                      <button onClick={() => setShowSetupWizard(integration.id)} className="flex-1 px-3 py-2 rounded-full text-xs font-medium text-white  bg-[bdeed3] ">
                        إعداد يدوي
                      </button>
                    </>}
                </div>
