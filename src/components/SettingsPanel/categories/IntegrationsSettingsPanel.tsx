...
export const IntegrationsSettingsPanel: React.FC<IntegrationsSettingsPanelProps> = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-transparent">
      ...
      <div style={{ backgroundColor: '#96d8d0' }} className="rounded-3xl p-6 border border-black/10">
      ...
      <div style={{ backgroundColor: '#F2FFFF' }} className="rounded-3xl p-6 border border-black/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {integrations.map(integration => {
            ...
            return (
              <div key={integration.id} style={{ backgroundColor: '#bdeed3' }} className="rounded-2xl p-4 border border-black/10">
