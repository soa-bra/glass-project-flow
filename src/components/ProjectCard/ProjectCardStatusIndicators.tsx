...
const ProjectCardStatusIndicators = ({
  ...
  return <div className="flex items-center justify-between py-[5px] my-[5px] px-px mx-px">
      ...
      {/* التاريخ */}
      <div className="bg-white/60 backdrop-blur-sm rounded-full py-0 mx-[60px] px-[21px]">
      ...
      {/* المكلف */}
      <div className="bg-white/60 backdrop-blur-sm rounded-full py-0 px-0 mx-[9px]">
      ...
      {/* القيمة */}
      <div className="bg-white/60 backdrop-blur-sm rounded-full my-0 py-0 mx-0 px-[21px]">
        <span className="text-sm font-arabic text-gray-700">
          {value}
        </span>
      </div>
