...
const ProjectCardStatusIndicators = ({
  ...
  return <div className="flex items-center justify-between py-0 mx-0 px-[28px] my-[24px]">
      ...
      <div className="flex items-center gap-[3px] flex-1 justify-end mx-[65px] px-[2px]">
        {/* التاريخ */}
        <div style={{
        ...
        <div style={{
        backgroundColor: '#E3E3E3'
      }} className="rounded-full justify-between flex items-center bg-[soabra-projects-bg] py-[2px] px-[8px] mx-[5px]">
