...
const ProjectCardHeader = ({
  ...
  return (
    <div
      dir="rtl"
      className="relative grid grid-cols-[auto_minmax(0,1fr)_auto] items-start gap-2 sm:gap-3 mb-2 py-2 sm:py-3 px-2 sm:px-3 h-[120px] sm:h-[140px] overflow-hidden"
    >
