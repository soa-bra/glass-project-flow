...
const ProjectCardDaysCircle = ({
  ...
  return <div className="w-[75px] h-[75px] rounded-full border-2 border-gray-300 flex flex-col items-center justify-center bg-F2F2F2 backdrop-blur-sm my-0 py-0 mx-0 px-0 bg-transparent">
