...
const ProjectsList = ({ onProjectSelect, isCompressed }: ProjectsListProps) => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'success': return '#5DDC82';
      case 'warning': return '#ECFF8C';
      case 'error': return '#F23D3D';
      case 'neutral': return '#EDEDEE';
      default: return '#EDEDEE';
    }
  };
  ...
  return (
    <div className="h-full bg-soabra-projects-bg rounded-2xl shadow-lg border border-gray-100 overflow-hidden z-projects glass">
            ...
            {projects.map((project) => {
              ...
              return (
                <div
                  ...
                  className="h-20 bg-soabra-card-bg project-card rounded-xl p-4 cursor-pointer 
                           hover:opacity-90 hover:shadow-lg transition-all duration-300 
                           border border-white/20 backdrop-blur-sm glass-hover"
                >
