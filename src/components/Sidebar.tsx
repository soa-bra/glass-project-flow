...
import { Home, Building, Users, Archive, ChevronLeft, ChevronRight, Settings } from 'lucide-react';
...
const Sidebar = ({ onToggle, onSectionChange, activeSection = 'home' }: SidebarProps) => {
  const [isCollapsed, setIsCollapsed] = useState(false);

  const menuItems = [
    { id: 'home', icon: Home, label: 'الرئيسية' },
    { id: 'departments', icon: Building, label: 'الإدارات' },
    { id: 'collaborative', icon: Users, label: 'التخطيط التشاركي' },
