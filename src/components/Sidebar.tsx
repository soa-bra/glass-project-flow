  ...
  return (
    <aside className={`bg-soabra-solid-bg z-sidebar h-full backdrop-blur-xl rounded-3xl transition-all duration-500 ease-in-out ${isCollapsed ? 'w-20' : 'w-60'}`}>
      <nav className="flex flex-col gap-2 py-0 my-0 px-0 mx-0">
            ...
            >
              ...
              <div 
                className={`flex-1 flex items-center transition-all duration-500 ease-in-out ${
                  isCollapsed 
                    ? 'opacity-0 translate-x-6 scale-95 w-0' 
              ...
              >
                {!isCollapsed && (
                  <>
                    ...
                    {item.active && (
                      <div 
                        className={`w-2 h-2 bg-[#3e494c] rounded-full ml-auto mr-4 transition-all duration-400 ease-in-out group-hover:scale-110 ${
        ...
        <div 
          className={`mt-auto pt-2 py-0 my-0 transition-all duration-500 ease-in-out ${
            isCollapsed 
