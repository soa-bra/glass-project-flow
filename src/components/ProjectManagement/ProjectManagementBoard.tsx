    ...
    switch (activeTab) {
      case 'overview':
        return <>
            ...
            <div className="flex justify-between items-start mb-6 flex-shrink-0 py-0 my-0 px-[10px]">
              ...
              <div className="flex-shrink-0">
                <div className="grid grid-cols-3 gap-6 my-0 px-0">
                  {/* الإيرادات المتوقعة */}
            ...
            {/* شريط تقدم المراحل */}
            <div className="flex-shrink-10 my-0 px-0 mx-[50px]">
