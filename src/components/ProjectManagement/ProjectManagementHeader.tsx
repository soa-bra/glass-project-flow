      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" sideOffset={5} className="w-48 bg-white/70 backdrop-blur-lg border border-white/80 shadow-lg font-arabic z-[9999] rounded-full">
              <DropdownMenuItem onClick={onEdit} className="flex items-center gap-2 text-black hover:bg-white/60 cursor-pointer">
                <Edit className="w-4 h-4" />
                تعديل المشروع
              </DropdownMenuItem>
              <DropdownMenuItem onClick={onArchive} className="flex items-center gap-2 text-black hover:bg-white/60 cursor-pointer">
