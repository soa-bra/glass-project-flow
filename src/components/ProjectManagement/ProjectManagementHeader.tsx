                ...
                >
                  <div className="flex flex-col items-start gap-2 w-48">
                    <motion.button
                      ...
                      className="flex items-center gap-2 text-gray-700 cursor-pointer px-3 py-2 w-full text-right rounded-3xl hover:bg-white/60"
                      style={{
                    ...
                    <motion.button
                      ...
                      className="flex items-center gap-2 text-red-600 cursor-pointer px-3 py-2 w-full text-right rounded-3xl hover:bg-red-50"
                      style={{
                        background: "rgba(255,255,255,0.4)",
                        backdropFilter: "blur(20px)",
                        WebkitBackdropFilter: "blur(20px)",
