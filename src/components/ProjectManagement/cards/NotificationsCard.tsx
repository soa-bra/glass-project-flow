...
export const NotificationsCard: React.FC = () => {
  ...
  return <div className="h-full p-6 rounded-3xl border border-white/20" style={{
    background: '#f7ffff',
    fontFamily: 'IBM Plex Sans Arabic'
      ...
      <div className="space-y-10 max-h-55 overflow-y-auto my-[65px]">
        {notifications.map(notification => {
        const Icon = notification.icon;
        return <div key={notification.id} className="flex items-start gap-3 p-2 rounded-lg hover:bg-white/50 transition-colors py-0">
              <Icon size={16} style={{
