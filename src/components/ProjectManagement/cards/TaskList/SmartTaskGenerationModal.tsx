  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={() => {}}>
        <DialogContent 
          className="bg-white border border-border rounded-[24px] shadow-[0_1px_1px_rgba(0,0,0,0.03),0_8px_24px_rgba(0,0,0,0.06)] p-0 max-w-3xl max-h-[90vh] overflow-hidden font-arabic"
        >
