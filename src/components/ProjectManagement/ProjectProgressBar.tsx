...
export const ProjectProgressBar: React.FC<ProjectProgressBarProps> = ({
  ...
  return <div style={{
    background: 'transparent'
  }} className="relative w-full flex flex-row-reverse items-center font-arabic pt-0 pb-0 mx-0 px-[150px] py-[16px] my-[25px]">
      ...
      {stages[currentStageIndex] && <div className="flex items-center gap-3  mx-0">
          <div style={{
