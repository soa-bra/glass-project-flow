...
export const ProjectProgressBar: React.FC<ProjectProgressBarProps> = ({
  ...
  return <div style={{
    background: 'transparent'
  }} className="relative w-full flex flex-row-reverse items-center font-arabic pt-0 pb-0 py-[4px] my-[15px] mx-0 px-[30px]">
          ...
          top: `-${(circleSize - segmentHeight) / 2}px`
            ...
            boxShadow: isCompleted ? '0 0 6px #b9f3a8' : 'inset 0 0 2px rgba(0,0,0,0.25)'
                ...
                {isCompleted ? <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="3" strokeLinecap="square" strokeLinejoin="miter">
                  ...
                  </svg> : <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="3" strokeLinecap="square" strokeLinejoin="miter">
      ...
      {stages[currentStageIndex] && <div className="flex items-center gap-3 ml-[30px] mx-0">
          <div style={{
        width: `${bubbleSize}px`,
