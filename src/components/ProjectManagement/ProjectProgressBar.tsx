...
export const ProjectProgressBar: React.FC<ProjectProgressBarProps> = ({
  ...
  return (
    <div 
      ...
      className="relative w-full flex justify-center items-center font-arabic pt-0 pb-0 py-[5px] mx-0 my-[5px] px-[25px]"
    >
      {/* الحاوي المركزي لشريط التقدم */}
      <div className="flex items-center justify-center gap-6 w-full max-w-6xl">
        
        {/* فقاعة المرحلة الحالية - على اليسار */}
        ...
        {/* شريط الشرائح - في المنتصف */}
        <div 
          ref={barRef} 
          className="relative flex items-center justify-center flex-row-reverse gap-[3px] flex-1 h-[25px] max-w-4xl"
        >
          {segments.map((idx) => {
