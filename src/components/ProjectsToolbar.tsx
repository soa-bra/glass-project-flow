...
const ProjectsToolbar = () => {
  return (
    <div className="flex items-center justify-between h-14 py-0 px-[10px] my-[16px]">
      {/* الأيقونات يميناً */}
      <div className="flex items-center gap-3">
        <button className="w-[40px] h-[40px] rounded-full border-2 border-[#3e494c]/50 bg-transparent flex items-center justify-center transition-all duration-300 hover:bg-white/20 group">
