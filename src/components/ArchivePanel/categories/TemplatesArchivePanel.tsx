...
export const TemplatesArchivePanel: React.FC = () => {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'تقارير': return 'bg-blue-100 text-blue-800 border-blue-200';
      case 'عروض تقديمية': return 'bg-purple-100 text-purple-800 border-purple-200';
      case 'نماذج إدارية': return 'bg-green-100 text-green-800 border-green-200';
      case 'قانونية': return 'bg-red-100 text-red-800 border-red-200';
