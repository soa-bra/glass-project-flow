...
export const mockEmployees: Employee[] = [
  ...
  },
  {
    ...
    email: "khalid.shamri@SoaBra.com",
    phone: "+966503456789",
    position: "محاسب أول",
    department: "المالية",
    hireDate: "2022-08-10",
...
export const mockPerformanceReviews: PerformanceReview[] = [
  {
    ...
    developmentPlan: ["دورة في مهارات العرض والتقديم", "ورشة عمل في إدارة الفرق", "شهادة في أمن المعلومات"],
...
export const mockJobPostings: JobPosting[] = [
  {
    ...
    qualifications: ["بكالوريوس في علوم الحاسب أو مجال ذي صلة", "شهادات تقنية معتبرة (مفضلة)", "مهارات تواصل ممتازة"],
  ...
  },
  {
    ...
    qualifications: ["بكالوريوس في التصميم الجرافيكي", "معرض أعمال قوي", "مهارات إبداعية متميزة"],
