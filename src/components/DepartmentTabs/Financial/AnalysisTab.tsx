...
export const AnalysisTab: React.FC = () => {
  ...
  return <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Expense Categories */}
        <UnifiedSystemCard title="توزيع المصروفات" icon={<PieChart className="px-[4px]" />}>
          <ResponsiveContainer width="100%" height={300}>
            <RechartsPieChart>
              ...
              percent
                ...
                {mockExpenseCategories.map((entry, index) => <Cell key={`cell-${index}`} fill={colors[index % colors.length]} />)}
              </Pie>
        ...
        {/* AI Predictions */}
        <UnifiedSystemCard title="التنبؤات المالية" icon={<Target className="px-[4px]" />}>
