...
export const FinancialOverviewTab: React.FC = () => {
  const kpis: KPI[] = [
    { title: 'إجمالي الإيرادات', value: '2.4 مليون ريال', change: 12.5, trend: 'up', icon: DollarSign },
    { title: 'صافي الربح', value: '486 ألف ريال', change: 8.2, trend: 'up', icon: TrendingUp },
    { title: 'التدفق النقدي', value: '320 ألف ريال', change: -3.1, trend: 'down', icon: CreditCard },
    { title: 'نسبة تحقيق الأهداف', value: '87%', change: 5.4, trend: 'up', icon: Target }
  ];

  const budgetAlerts: BudgetAlert[] = [
    { project: 'مشروع التطوير الرقمي', percentage: 92, amount: '18,400 ريال', severity: 'danger' },
    { project: 'حملة التسويق الصيفية', percentage: 85, amount: '12,750 ريال', severity: 'warning' },
    { project: 'تطوير التطبيق الجوال', percentage: 78, amount: '9,340 ريال', severity: 'warning' }
  ];

  const monthlyTrend = [
    { month: 'يناير', revenue: 180000, expenses: 120000 },
    { month: 'فبراير', revenue: 210000, expenses: 140000 },
    { month: 'مارس', revenue: 240000, expenses: 155000 },
    { month: 'أبريل', revenue: 220000, expenses: 145000 },
    { month: 'مايو', revenue: 280000, expenses: 175000 },
    { month: 'يونيو', revenue: 320000, expenses: 185000 }
  ];
              ...
              <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex-1">
                  ...
                  <div className="space-y-2">
                    ...
                    <Progress 
                      value={(month.expenses / month.revenue) * 100} 
                      className="h-2"
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2">
                  <Progress 
                    ...
                    indicatorClassName={alert.severity === 'danger' ? 'bg-red-500' : 'bg-orange-500'}
                  />
