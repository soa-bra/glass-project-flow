...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'hsl(var(--oc-column-3-bg))' }}>
      ...
      {/* Content */}
      <div className="flex-1 overflow-auto pb-6 px-6" style={{ background: 'hsl(var(--oc-column-3-bg))' }}>
