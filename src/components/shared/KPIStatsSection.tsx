 ...
 * يستخدم نفس التنسيق عبر جميع لوحات التطبيق
 */
export const KPIStatsSection: React.FC<KPIStatsSectionProps> = ({
  ...
  if (!stats || stats.length === 0) {
    return (
      <div className={`grid grid-cols-3 gap-6 mb-6 my-0 px-[4px] mx-[10px] ${className}`}>
  ...
  return (
    <div className={`grid grid-cols-3 gap-6 mb-6 my-0 px-0 mx-[5px] ${className}`}>
