...
const ShapesPanel: React.FC = () => {
  ...
  const stickyColors = ["#3B82F6", "#F87171", "#FBBF24", "#E9D5FF", "#BBF7D0", "#93C5FD", "#FBCFE8", "#FEF9C3"];
    ...
    <div className="space-y-5" dir="rtl">
      ...
      {activeTab === "shapes" && (
        <div className="space-y-5">
          ...
          <div className="space-y-4">
            <h4 className="text-[13px] font-semibold text-[hsl(var(--ink))]">الحواف</h4>

            {/* Stroke Width */}
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-[12px] text-[hsl(var(--ink-60))]">سمك الحواف</label>
      ...
      {activeTab === "icons" && (
        <div className="space-y-5">
          ...
          {/* Icons Grid */}
          <div>
            <h4 className="text-[13px] font-semibold text-[hsl(var(--ink))] mb-3">مكتبة الأيقونات</h4>
            <div className="grid grid-cols-4 gap-2">
      ...
      {activeTab === "arrows" && (
        <div className="space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-[12px] text-[hsl(var(--ink-60))]">سمك السهم</label>
              <div className="flex items-center gap-1">
                <input
                  type="number"
                  min={1}
          ...
          {/* Arrows Grid */}
          <div>
            <h4 className="text-[13px] font-semibold text-[hsl(var(--ink))] mb-3">الأسهم والاتجاهات</h4>
            <div className="grid grid-cols-4 gap-2">
              {arrows.map((arrow) => {
      ...
      {activeTab === "sticky" && (
        <div className="space-y-5">
          <h4 className="text-[13px] font-semibold text-[hsl(var(--ink))] text-right">ستيكي نوت</h4>

          {/* Sticky Color Selection */}
          <div>
            <label className="text-[13px] font-semibold text-[hsl(var(--ink))] mb-3 block text-right">اللون</label>
          ...
          {/* Sticky Text Input */}
          <div>
            <label className="text-[13px] font-semibold text-[hsl(var(--ink))] mb-3 block text-right">النص</label>
            <input
              type="text"
              value={stickyText}
          ...
          {/* Preview */}
          <div>
            <label className="text-[13px] font-semibold text-[hsl(var(--ink))] mb-3 block text-right">معاينة:</label>
            <div
              className="w-full p-4 rounded-[12px] min-h-[80px] flex items-center justify-center"
              style={{ backgroundColor: selectedStickyColor }}
            >
              <span className="text-[14px] font-medium text-[hsl(var(--ink))]">{stickyText || "نص تجريبي"}</span>
            </div>
          </div>
      ...
      <div className="bg-[hsl(var(--accent-blue))]/5 rounded-[12px] p-4 space-y-2">
        <p className="text-[12px] text-[hsl(var(--accent-blue))] text-center">🎨 اختر الألوان المناسبة لتصميمك</p>
        <p className="text-[12px] text-[hsl(var(--accent-blue))] text-center">📐 الأشكال قابلة لتغيير الحجم</p>
        <p className="text-[12px] text-[hsl(var(--accent-blue))] text-center">📝 ستيكي نوت مفيدة للملاحظات السريعة</p>
      </div>
    </div>
  );
};
