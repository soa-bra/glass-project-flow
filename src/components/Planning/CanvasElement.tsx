...
const CanvasElement: React.FC<CanvasElementProps> = ({
  ...
  const handleMouseMove = useCallback(
    (e: MouseEvent) => {
      if (!isDraggingRef.current || isLocked || useCanvasStore.getState().isInternalDrag || disableDrag) return;
    ...
    [element, updateElement, snapToGrid, viewport, isLocked, disableDrag],
  );
  ...
  }, [handleMouseMove, handleMouseUp, disableDrag]);
