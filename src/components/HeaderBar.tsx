...
const HeaderBar = () => {
  ...
  const handleImageError = () => {
    console.error('فشل في تحميل صورة الشعار من المسار: /lovable-uploads/9a8b8ed4-b3d6-4ecf-b62c-e6c1eba8c3d4.png');
    setImageError(true);
  };
  ...
  return (
    <header className="fixed top-0 right-0 left-0 h-[60px] bg-soabra-sidebar-bg z-header my-0 py-[65px] px-[5px] group">
      <div className="flex items-center justify-between h-full px-0">
        ...
        <div className="text-right ml-4 mx-[5px] flex items-center">
          {!imageError ? (
            ...
            <div className="h-12 w-24 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/30 px-0 mx-[22px]">
        ...
        <div className="flex items-center gap-0 px-0 mx-0">
          <button className="p-2 opacity-0 group-hover:opacity-100 hover:bg-white/20 transition-all duration-300 group rounded-full">
