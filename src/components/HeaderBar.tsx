...
const HeaderBar = () => {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 h-[60px] bg-soabra-sidebar-bg z-header my-0 px-[25px] py-[65px]">
        ...
        <div className="text-right ml-4 mx-[5px] flex items-center">
          {!imageError ? (
            <img 
              ...
              alt="SoaBra Logo" 
              className="h-12 w-auto object-contain transition-opacity duration-300 rounded-full border border-white/30" 
            ...
            <div className="h-12 w-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/30">
