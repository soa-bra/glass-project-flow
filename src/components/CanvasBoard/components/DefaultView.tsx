        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[1, 2, 3].map(i => <Card key={i} className="cursor-pointer hover:shadow-md transition-all bg-white/60 backdrop-blur-sm">
                <CardContent className="cursor-pointer hover:shadow-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm rounded-3xl bg-[soabra-solid-bg] bg-slate-300">
                  <div className="h-24 rounded-lg mb-3 flex items-center justify-center bg-gray-800">
