...
export const ToolPanel: React.FC<ToolPanelProps> = (props) => {
  ...
  const renderPanelContent = () => {
    switch (selectedTool) {
      ...
      default:
        return (
          <div className="flex items-center justify-center h-32 text-gray-500 text-sm font-arabic">
  ...
  return (
    <Card className="bg-white/95 backdrop-blur-md shadow-sm border border-gray-300 rounded-[20px] h-full">
