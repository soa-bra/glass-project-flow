  ...
  return <Card className="w-full h-full bg-[#f2f9fb]/95 backdrop-blur-xl shadow-sm border border-white/20 rounded-[32px] overflow-hidden my-0 py-0">
      ...
      <CardContent className="h-[calc(100%-4rem)] p-0">
        <Tabs defaultValue="participants" className="h-full flex flex-col">
          <TabsList className="grid w-full grid-cols-3 bg-transparent p-1 mx-0 py-0 px-[5px]">
            <TabsTrigger value="participants" className=" h-5 w-14 bg-[#96d8d0] hover:bg-[#96d8d0]/80 text-black border-none mx-0 text-xs rounded-full">
              المشاركين
            </TabsTrigger>
