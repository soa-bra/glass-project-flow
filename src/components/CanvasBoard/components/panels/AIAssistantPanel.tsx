...
export const AIAssistantPanel: React.FC = () => {
  ...
  return <Card className="w-full h-full bg-[#f2f9fb]/95 backdrop-blur-xl shadow-sm border border-white/20 rounded-[32px] overflow-hidden my-0 py-0">
      ...
      <CardContent className="space-y-4 h-[calc(100%-4rem)] flex flex-col">
        ...
        <div className="flex gap-2 justify-between">
          <Button onClick={handleFinishWorkIntelligently} size="sm" title="إنهاء العمل بذكاء" className="h-6 rounded-[16px] bg-[#a4e2f6] hover:bg-[#a4e2f6]/80 text-black border-none">
            <Play className="w-4 h-4" />
          </Button>
          <Button onClick={handleSmartReview} size="sm" title="المراجعة الذكية" className="h-6 rounded-[16px] bg-[#a4e2f6] hover:bg-[#a4e2f6]/80 text-black border-none">
            <Search className="w-4 h-4" />
          </Button>
          <Button onClick={handleSmartCleanup} size="sm" title="التنظيف الذكية" className="h-6 rounded-[16px] bg-[#a4e2f6] hover:bg-[#a4e2f6]/80 text-black border-none">
        ...
        <div className="flex-1 flex flex-col space-y-3">
          <div className="bg-[#e9eff4] p-3 rounded-[16px] flex-1 min-h-0 py-[5px]">
