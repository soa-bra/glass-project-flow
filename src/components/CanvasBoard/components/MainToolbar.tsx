...
const MainToolbar: React.FC<MainToolbarProps> = ({
  ...
  return <TooltipProvider>
      <div className="fixed bottom-6 z-50 mx-0 my-[20px]">
        <Card className="bg-white/95 backdrop-blur-lg shadow-sm border border-gray-200/50 rounded-[24px] my-[10px]">
          <CardContent className="flex items-center gap-3 p-4 py-0 rounded-full my-[8px] px-[10px]">
