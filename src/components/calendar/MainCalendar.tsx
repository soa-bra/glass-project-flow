    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="flex-1 p-6">
        ...
        <div className="grid grid-cols-7 gap-2 mb-4">
          {weekDays.map(day => (
            <div key={day} className="text-center text-sm font-semibold text-soabra-text-secondary py-2">
              {day}
            </div>
          ))}
        </div>
              ...
              >
                ...
                <div className="space-y-1">
                  {dayEvents.slice(0, 2).map((event, eventIndex) => (
                    <div
                      key={eventIndex}
                      className="text-xs px-2 py-1 rounded-lg text-white truncate font-medium"
