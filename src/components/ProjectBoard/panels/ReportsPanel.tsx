...
export const ReportsPanel: React.FC<ReportsPanelProps> = ({ project }) => {
  return (
      ...
      <div className="rounded-3xl bg-white/30 backdrop-blur-xl p-6 shadow-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="text-center p-4 bg-white/40 rounded-xl">
            ...
            <div className="text-sm font-arabic text-gray-600">أعضاء الفريق</div>
          </div>
          <div className="text-center p-4 bg-white/40 rounded-xl">
            <div className="text-2xl font-bold text-gray-800">12</div>
            <div className="text-sm font-arabic text-gray-600">يوم متبقي</div>
          </div>
        </div>
      </div>
    </div>
