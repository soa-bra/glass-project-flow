        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Select value={selectedStatus} onValueChange={setSelectedStatus}>
              ...
              <SelectContent>
                ...
                {projectStatuses.map(status => <SelectItem key={status.value} value={status.value}>
                    {status.label}
                  </SelectItem>)}
              </SelectContent>
            </Select>
          ...
          <div className="space-y-3">
            ...
            <Select value={selectedProjectType} onValueChange={setSelectedProjectType}>
              ...
              <SelectContent>
                ...
                {projectTypes.map(type => <SelectItem key={type.value} value={type.value}>
                    {type.label}
                  </SelectItem>)}
              </SelectContent>
            </Select>
          ...
          <div className="space-y-3">
            ...
            <Select value={selectedPartnership} onValueChange={setSelectedPartnership}>
              ...
              <SelectContent>
                <SelectItem value="all">جميع الأنواع</SelectItem>
                {partnerships.map(partnership => <SelectItem key={partnership.value} value={partnership.value}>
                    {partnership.label}
                  </SelectItem>)}
              </SelectContent>
            </Select>
          ...
          <div className="space-y-3">
            ...
            <Select value={selectedProjectManager} onValueChange={setSelectedProjectManager}>
              ...
              <SelectContent>
                ...
                {projectManagers.map(manager => <SelectItem key={manager.value} value={manager.value}>
                    {manager.label}
                  </SelectItem>)}
              </SelectContent>
            </Select>
          ...
          <div className="space-y-3">
            ...
            <Select value={selectedRemainingDays} onValueChange={setSelectedRemainingDays}>
              ...
              <SelectContent>
                ...
                {remainingDaysOptions.map(option => <SelectItem key={option.value} value={option.value}>
                    {option.label}
                  </SelectItem>)}
              </SelectContent>
            </Select>
