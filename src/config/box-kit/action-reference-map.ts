...
export const ACTION_STATUS_REFERENCE_MAP = {
  ...
  'ACT-STS-S02': { variant: 'successOutline', style: 'outline', background: 'transparent', foreground: '#000000', border: '#d9d2fd' },
  'ACT-STS-W01': { variant: 'warning', style: 'filled', background: '#fbe2aa', foreground: '#000000' },
  'ACT-STS-W02': { variant: 'warningOutline', style: 'outline', background: 'transparent', foreground: '#000000', border: '#fbe2aa' },
  'ACT-STS-E01': { variant: 'error', style: 'filled', background: '#f1b5b9', foreground: '#000000' },
  'ACT-STS-E02': { variant: 'errorOutline', style: 'outline', background: 'transparent', foreground: '#000000', border: '#f1b5b9' },
  'ACT-STS-I01': { variant: 'info', style: 'filled', background: '#a4e2f6', foreground: '#000000' },
  'ACT-STS-I02': { variant: 'infoOutline', style: 'outline', background: 'transparent', foreground: '#000000', border: '#a4e2f6' },
  'ACT-STS-AN01': { variant: 'actionNed', style: 'filled', background: '#d9d2fd', foreground: '#000000' },
  'ACT-STS-AN02': { variant: 'actionNedOutline', style: 'outline', background: 'transparent', foreground: '#000000', border: '#d9d2fd' },
