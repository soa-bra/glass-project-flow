...
Generated by rerunning the static import-graph scan used for the earlier zero-reference candidate report.

## Baseline summary

- baseline القديم: **95**
- removed in Batch A: **22**
- current candidates بعد إعادة الفحص: **116**

## Scan notes

- مصدر الفحص هو import graph الحالي من ملفات `src/**/*.{ts,tsx,js,jsx,mjs,cjs}`.
- يدعم الفحص imports/exports الثابتة و`import(...)` المباشر مع resolution تقريبي لمسارات `@/` والمسارات النسبية و`index.*`.
- لم تُستخدم `docs/reports/zero-reference-candidates-2026-05-05.md` كأساس حذف مباشر؛ أُعيد الفحص من الشجرة الحالية ثم استُخدم `docs/reports/batch-a-closure.md` فقط لاستبعاد أي مسارات مذكورة كمحذوفة.
- الملفات المحذوفة المذكورة في `docs/reports/batch-a-closure.md` غير موجودة في الشجرة الحالية؛ لذلك لا تظهر ضمن قائمة المرشحين أدناه.

## Excluded deleted paths from Batch A closure
...
- `src/features/planning/domain/types/ai-tools.types.ts`
- `src/features/planning/domain/types/canvas.types.ts`
- `src/features/planning/domain/types/component-props.types.ts`
- `src/features/planning/domain/types/diagram.types.ts`
- `src/features/planning/domain/types/element.types.ts`
- `src/features/planning/domain/types/enhanced.types.ts`
- `src/features/planning/domain/types/event.types.ts`
- `src/features/planning/domain/types/hook.types.ts`
- `src/features/planning/domain/types/mindmap.types.ts`
- `src/features/planning/domain/types/planning.types.ts`
- `src/features/planning/domain/types/smart-doc.types.ts`
- `src/features/planning/domain/types/smart.types.ts`
- `src/features/planning/domain/types/system-model.types.ts`
...
- `src/modules/crm/opportunity.service.ts`
...
- `src/services/central/audit.service.ts`
- `src/services/central/centralBoards.service.ts`
- `src/services/central/departments.service.ts`
- `src/services/central/dependencies.service.ts`
- `src/services/central/engineJobs.service.ts`
- `src/services/central/projects.service.ts`
- `src/services/central/roles.service.ts`
- `src/services/central/search.service.ts`
- `src/services/central/tasks.service.ts`
- `src/services/central/tools.service.ts`
...
- `src/shared/index.ts`
- `src/shared/services/approvals/approvals.service.ts`
- `src/shared/services/feature-store/fs.service.ts`
- `src/shared/services/sequence/sequence.service.ts`
- `src/stories/BaseBadge.stories.tsx`
- `src/stories/BaseBox.stories.tsx`
- `src/stories/BaseListItem.stories.tsx`
- `src/stories/BasePageHeader.stories.tsx`
- `src/stories/BaseSearchBar.stories.tsx`
