...
| 8 | تنفيذ Runtime Verification حقيقي | Done | `docs/recovery/step-08-runtime-verification.md`, `docs/recovery/evidence/step08-login-check.txt`, `docs/recovery/evidence/step08-project-cr-check.txt`, `docs/recovery/evidence/step08-task-cru-check.txt`, `docs/recovery/evidence/step08-invoice-cru-check.txt`, `docs/recovery/evidence/step08-department-shell-read-check.txt` | أُغلقت بعد تنفيذ تحقق حي على مشروع Supabase الفعلي مع PASS في جميع السيناريوهات الخمسة وتنظيف بيانات الاختبار. |
