...
| 8 | تنفيذ Runtime Verification حقيقي | Blocked | `docs/recovery/step-08-runtime-verification.md`, `docs/recovery/step-08-blocker-record.md` | التنفيذ متوقف لحين توفر بيئة تشغيل حية لإثبات workflows الخمسة. |
