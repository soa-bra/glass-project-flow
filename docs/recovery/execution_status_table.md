...
| 11 | توثيق صلاحيات النظام | Blocked | `docs/recovery/step-11-blocker-record.md`, `scripts/recovery/permissions-probes.sql` | المتبقي يتطلب اختبار runtime متعدد الأدوار على DB فعلية. |
