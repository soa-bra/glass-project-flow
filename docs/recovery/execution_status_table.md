...
| 10 | توثيق Baseline Schema رسمي | In Progress | `docs/recovery/step-10-baseline-schema.md`, `supabase/migrations/20260430160310_91fd3b59-915f-463d-8e01-63b1c31b6330.sql` | تم توثيق الجداول/العلاقات baseline؛ متبقي snapshot DB فعلي وإصدار baseline نهائي. |
| 11 | توثيق صلاحيات النظام | In Progress | `docs/recovery/step-11-permissions-matrix.md`, `docs/RBAC.md`, `src/services/central/withAuthorizationAndAudit.ts` | تم إنشاء matrix أولية وربطها بـRLS/App؛ متبقي mapping policy-by-policy + أدلة deny/allow. |
